...
df1 = pd.read_csv("../501sc_data/501sc.csv")
print(df1.head())
print(df1.columns)
print(df1.shape)
...
for jj in df1.index:
  ...
  sentences.append(df1[choice_names[df1["target"][jj]]][jj]) 

  answer = choice_names[df1["target"][jj]]
  answers.append(answer)
  
  for ii in range(len(choice_names)):
    tokens = df1[choice_names[ii]][jj].split()
...
df_out.to_csv("501sc_set_1blank.csv")
